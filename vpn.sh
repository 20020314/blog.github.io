...
#
# Copyright (C) 2016-2017 Teddysun <2594133825@qq.com>
#
...
error_detect_depends(){
 ...
        echo "Please visit our website: https://chaikair.cc for help"
        exit 1
    fi
}
...
install_shadowsocks_python() {
 ...
        echo "Please email to Teddysun <chaikair> and contact."
        install_cleanup
        exit 1
    fi
}
...
install_shadowsocks_r() {
 ...
        echo "Please email to Teddysun <2594133825@qq.com> and contact."
        install_cleanup
        exit 1
    fi
}
...
install_main(){
    ...
    echo
    echo "Welcome to visit: chaikair.cc"
    echo "Enjoy it!"
    echo
}
